    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**المكالمة مقفلة**\n\nيرجى التأكد من فتح  مكالمة المجموعة. إذا تم الفتح بالفعل ، فقم بقفلها وفتحها مرة أخرى وإذا استمرت المشكلة, اضغط الأمر الي في الاسفل\n /restart"
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**الحساب المساعد موجود في المكالمة**\n\n"

"اكتشفت الأنظمة أن المساعد موجود بالفعل في الدردشة الصوتية ، وعادةً ما تظهر هذه المشكلة عند تشغيل استعلامين معًا .\n\nإذا لم يكن المساعد موجودًا في الدردشة الصوتية ، يرجى إنهاء الدردشة الصوتية وبدء محادثة صوتية جديدة مرة أخرى وإذا كانت المشكلة تواصل ، حاول  /restart"
            )
        except TelegramServerError:
            raise AssistantErr(
                "**خطأ في سيرفرات التيلجرام**\n\n"

"يواجه التليجرام بعض مشكلات السيرفر الداخلي ، يرجى محاولة التشغيل مرة أخرى.\n\n إذا استمرت هذه المشكلة في الظهور كل مرة ، يرجى إنهاء الدردشة الصوتية وبدء محادثة صوتية جديدة."
            )
