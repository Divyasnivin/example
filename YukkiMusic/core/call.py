...
class Call(PyTgCalls):
    ...
    async def join_call(
        ...
        try:
            ...
            raise AssistantErr(
                "**الحساب المساعد موجود في المكالمة**\n\nاكتشفت الأنظمة أن المساعد موجود بالفعل في الدردشة الصوتية ، وعادةً ما تظهر هذه المشكلة عند تشغيل مقطعين معًا.\n\nإذا لم يكن المساعد موجودًا في الدردشة الصوتية ، يرجى إنهاء الدردشة الصوتية وبدء محادثة صوتية جديدة مرة أخرى وإذا كانت المشكلة تواصل ، حاول ``ريستارت"
            )
