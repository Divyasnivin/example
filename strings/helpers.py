...
🎷** الادمنية :**
** ▪︎يقدر يستخدم أوامر البوت بدون اشراف**.
...
/play او /vplay  \n ▪︎للتشغيل اكتب اسم الاغنية بعد مثال: \n `/play معقول زينه عماد`\n `/vplay معقول زينه عماد`

/playforce او /vplayforce  \n ▪︎التشغيل بالقوة يوقف الاغنية الي شغالة ويشغل الاغنية الي بحثت عنها بالأمر ويمسح قائمة الانتظار

/ربط  [يوزر القناة او ايدي القناة] \n▪︎ لربط القناة بالقروب ويمديك تشغل من القروب بس لازم ترفع البوت مشرف في القناة وفي القروب وتربطها مثال : \n `/ربط kkcet`
